...
const copy = {
  ru: {
    ...
    delivery: {
      ...
      mapNote: "Точная зона доставки определяется по ZIP-коду.",
      ...
      zone2Cities: "Dania Beach, часть Hollywood, часть Pembroke Pines и Miramar, Bal Harbour, Bay Harbor Islands и Surfside.",
      zone3Label: "Зона C — $20",
      zone3Cities: "Отдельные ZIP-коды Fort Lauderdale, Wilton Manors и Oakland Park.",
      zone4Label: "Другие районы — по согласованию",
      zone4Cities: "Если ZIP-код не входит в автоматическую зону, доставка и её стоимость подтверждаются после проверки адреса.",
      footer: "Окончательная зона, доставка и минимальный заказ рассчитываются по ZIP-коду при оформлении заказа.",
    },
    testimonials: {
      eyebrow: "Отзывы",
  ...
  en: {
    ...
    delivery: {
      ...
      subtitle: "Your exact delivery option and fee are determined by ZIP code.",
      mapNote: "Your exact delivery zone is determined by ZIP code.",
      zone1Label: "Zone A — $10",
      zone1Cities: "Hallandale Beach, Aventura, Sunny Isles Beach, Golden Beach, parts of Hollywood and nearby areas.",
      zone2Label: "Zone B — $15",
      zone2Cities: "Dania Beach, parts of Hollywood, parts of Pembroke Pines and Miramar, Bal Harbour, Bay Harbor Islands and Surfside.",
      zone3Label: "Zone C — $20",
      zone3Cities: "Selected ZIP codes in Fort Lauderdale, Wilton Manors and Oakland Park.",
      zone4Label: "Other areas — delivery by confirmation",
      zone4Cities: "If your ZIP code is not in an automatic delivery zone, availability and delivery fee will be confirmed after the address is reviewed.",
      footer: "Final delivery zone, delivery fee and minimum order are calculated by ZIP code during checkout.",
    },
    testimonials: {
  ...
  uk: {
    ...
    delivery: {
      ...
      mapNote: "Точна зона доставки визначається за ZIP-кодом.",
      zone1Label: "Зона A — $10",
      zone1Cities: "Hallandale Beach, Aventura, Sunny Isles Beach, Golden Beach, частина Hollywood та найближчі райони.",
      zone2Label: "Зона B — $15",
      zone2Cities: "Dania Beach, частина Hollywood, частина Pembroke Pines і Miramar, Bal Harbour, Bay Harbor Islands та Surfside.",
      zone3Label: "Зона C — $20",
      zone3Cities: "Окремі ZIP-коди Fort Lauderdale, Wilton Manors та Oakland Park.",
      zone4Label: "Інші райони — за погодженням",
      zone4Cities: "Якщо ZIP-код не входить до автоматичної зони доставки, можливість і вартість доставки підтверджуються після перевірки адреси.",
      footer: "Остаточна зона, вартість доставки та мінімальне замовлення розраховуються за ZIP-кодом під час оформлення замовлення.",
    },
    testimonials: {
      eyebrow: "Відгуки",
