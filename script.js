...
const CITY_ACCEPTABLE_ZONES = {
  ...
  "surfside":           ["2"],
  "miramar":            ["2", "remote"],
  "pembroke pines":     ["1", "2", "remote"],
  "miami gardens":      ["2", "remote"],
  "fort lauderdale":    ["2", "3", "remote"],
...
const copy = {
  ru: {
    ...
    orderLook: {
      title: "Так выглядит ваш заказ",
      subtitle: "Готовим специально к вашему заказу, аккуратно упаковываем и передаём готовым к доставке.",
    },
    reviews: {
      title: "Что говорят наши клиенты",
      subtitle: "Спасибо за доверие — для нас особенно ценно, когда домашняя еда становится частью вашего стола.",
      r1: "«Всё было очень вкусно. Даже не знаю, что выделить — понравилось буквально всё. Буду вас очень рекомендовать.»",
      r1Author: "Ирина · Pompano",
      r2: "«Зразы очень вкусные.»",
      r2Author: "Анна · Sunny Isles",
      r3: "«Безумно всё вкусно! Мы в восторге. Всё, что попробовали, очень понравилось.»",
      r3Author: "Ольга · Aventura",
      r4: "«Ваш холодец — это шедевр. Ни капельки жира — именно такой я и хотела.»",
      r4Author: "Виктория · Hallandale",
    },
    categories: {
    ...
    preorder: {
      ...
      zone1: "Зона A — $10 · Hallandale Beach, Dania Beach, Hollywood",
      zone2: "Зона B — $15 · Aventura, North Miami Beach, Hollywood, Bal Harbour",
      zone3: "Зона C — $20 · Fort Lauderdale (33334), Oakland Park",
  ...
  en: {
    ...
    orderLook: {
      title: "This is what your order looks like",
      subtitle: "Prepared specially for your order, carefully packed, and ready for delivery.",
    },
    reviews: {
      title: "What our customers say",
      subtitle: "Thank you for your trust — it means so much when homemade food becomes part of your table.",
      r1: "\"Everything was delicious. I honestly don't even know what to highlight — we loved it all. I'll definitely recommend you.\"",
      r1Author: "Irina · Pompano",
      r2: "\"The zrazy are very delicious.\"",
      r2Author: "Anna · Sunny Isles",
      r3: "\"Everything is incredibly delicious! We're thrilled. We loved everything we tried.\"",
      r3Author: "Olga · Aventura",
      r4: "\"Your kholodets is a masterpiece. Not a bit of excess fat — exactly what I wanted.\"",
      r4Author: "Victoria · Hallandale",
    },
    categories: {
    ...
    preorder: {
      ...
      zone1: "Zone A — $10 · Hallandale Beach, Dania Beach, Hollywood",
      zone2: "Zone B — $15 · Aventura, North Miami Beach, Hollywood, Bal Harbour",
      zone3: "Zone C — $20 · Fort Lauderdale (33334), Oakland Park",
  ...
  uk: {
    ...
    orderLook: {
      title: "Так виглядає ваше замовлення",
      subtitle: "Готуємо спеціально до вашого замовлення, дбайливо пакуємо та передаємо готовим до доставки.",
    },
    reviews: {
      title: "Що кажуть наші клієнти",
      subtitle: "Дякуємо за довіру — для нас особливо цінно, коли домашня їжа стає частиною вашого столу.",
      r1: "«Усе було дуже смачно. Навіть не знаю, що виділити — сподобалося буквально все. Обов'язково буду вас рекомендувати.»",
      r1Author: "Ірина · Pompano",
      r2: "«Зрази дуже смачні.»",
      r2Author: "Анна · Sunny Isles",
      r3: "«Усе неймовірно смачно! Ми в захваті. Усе, що спробували, дуже сподобалося.»",
      r3Author: "Ольга · Aventura",
      r4: "«Ваш холодець — це шедевр. Жодної зайвої краплі жиру — саме такий я й хотіла.»",
      r4Author: "Вікторія · Hallandale",
    },
    categories: {
