...
const menuItems = [
  ...
  {
    id: "pork-chicken-cutlets",
    category: "main-dishes",
    price: 13.5,
    image: "assets/images/chicken-comfort.jpg",
    name: tr("Котлеты со свининой и курицей", "Pork and Chicken Cutlets", "Котлети зі свининою та куркою"),
    description: tr("Домашние сочные котлеты из свинины и курицы.", "Juicy homemade cutlets made with pork and chicken.", "Домашні соковиті котлети зі свинини та курки."),
  },
  {
    id: "beef-goulash",
    category: "main-dishes",
  ...
  },
  {
    ...
    price: 18.5,
    image: "assets/images/caucasus-mediterranean.jpg",
    name: tr("Цыпленок табака", "Chicken Tabaka", "Курча табака"),
  ...
  },
  {
    ...
    price: 15,
    image: "assets/images/chicken-comfort.jpg",
    name: tr("Отбивные по-гавайски", "Hawaiian-Style Chops", "Відбивні по-гавайськи"),
    description: tr("Отбивные с ананасом, сыром и мягким сладко-соленым вкусом.", "Chops with pineapple, cheese and a soft sweet-savory flavor.", "Відбивні з ананасом, сиром та м'яким солодко-солоним смаком."),
  },
  {
    id: "pork-chops",
    category: "main-dishes",
