...
const copy = {
  ru: {
    ...
    delivery: {
      ...
      zone4Cities: "Мы свяжемся с вами для уточнения возможности и стоимости доставки.",
  ...
  en: {
    ...
    delivery: {
      ...
      zone4Cities: "We'll contact you to confirm delivery availability and cost.",
  ...
  uk: {
    ...
    delivery: {
      ...
      zone4Cities: "Ми зв'яжемося з вами, щоб уточнити можливість і вартість доставки.",
